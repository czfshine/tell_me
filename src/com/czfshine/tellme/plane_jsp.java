 ...
 * Generated at: 2016-11-11 01:50:57 UTC
...
public final class plane_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t");
								...
								//out.println("SELECT *  FROM data WHERE touser=\'" + type + "\' limit "+(p-1)*max+","+max+";");
								ps = con.prepareStatement("SELECT *  FROM data WHERE touser=\'" + type + "\'   order by id desc limit "+(p-1)*max+","+max+" ;");
								rs = ps.executeQuery();
								String last="";
								while (rs.next()) {
...
out.print(type); 
      out.write("&p=1\" ><button type=\"button\" class=\"btn btn-primary  btn-sm right nofollow\">绠＄悊</button>\r\n");
      out.write("\t\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");

 ...
 * Generated at: 2016-11-11 01:52:21 UTC
...
public final class user_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	//PreparedStatement ps = con.prepareStatement("SELECT *  FROM data WHERE touser=\'" + type + "\';");
	...
	if(rs1.next()){//ç¨æ·å­å¨
		...
		if(pmd5.equals(m)){
			...
			ps1 = con.prepareStatement("INSERT INTO `plane`.`user` (`id`, `username`, `salt`, `md5`) VALUES ("+(maxid+1)+", '"+username+"', '"+salt+"', '"+pmd5+"');");
